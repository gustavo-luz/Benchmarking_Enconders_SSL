...
class TNC(L.LightningModule):
    ...
    def training_step(self, batch):
        ...
        self.log("timestamp", time.time(), on_step=True, on_epoch=False)
        print(f"\n\n\n Logging timestamp - Train Loss: {loss.item()},\n\n ")
        return loss
    ...
    def configure_optimizers(self):
        ...
        # optim = torch.optim.Adam(self.parameters(), lr=self.learning_rate,betas=(0.9, 0.99),weight_decay=3e-4)
        return optim
