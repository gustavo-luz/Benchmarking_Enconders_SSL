...
class MultiViewDataset(Dataset):
    ...
    def __init__(self, reader: _Reader, transform_pipelines: Sequence[_Transform]):
        ...
        assert isinstance(self.transform_pipelines, list), "Transforms must be a list"
        assert len(self.transform_pipelines) > 0, "At least one transform is required"
